...
public class ModuleServiceImpl implements ModuleService {
    ...
    @Override
    public void addModule(com.cloud.console.po.Module module) throws Exception {
        moduleMapper.insertModule(module);
    }

    @Override
    public void updateModule(com.cloud.console.po.Module module) throws Exception {
        moduleMapper.updateModule(module);
    }

    @Override
    public void delModule(List<com.cloud.console.po.Module> modules) throws Exception {
