...
import com.cloud.console.vo.Module;
...
public interface ModuleMapper {
    ...
    @Select("select a.id,a.name,a.url,b.name as parent,a.is_leaf,a.options,a.status from t_module a " +
    ...
    @Insert("insert into t_module(name,url,parent_id,options,is_leaf,status) values(#{name},#{url}," +
            "#{parent_id},#{options},#{is_leaf},#{status})")
    void insertModule(com.cloud.console.po.Module module);
    ...
    @Update("<script>" +
            ...
            " where id=#{id}" +
            "</script>")
    void updateModule(com.cloud.console.po.Module module);
    ...
    @Delete("<script>" +
            ...
            "</foreach></if>" +
            "</script>")
    void delModule(List<com.cloud.console.po.Module> modules);
}
