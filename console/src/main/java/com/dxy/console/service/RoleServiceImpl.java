...
import com.dxy.console.mapper.RoleMapper;
import com.dxy.console.po.Role;
import com.dxy.console.po.RoleAuth;
import com.dxy.console.vo.Auths;
import com.dxy.console.vo.Permission;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public void addRole(com.dxy.console.po.Role module) throws Exception {
        roleMapper.insertRole(module);
    }

    @Override
    public void updateRole(com.dxy.console.po.Role module) throws Exception {
        roleMapper.updateRole(module);
    }

    @Override
    public void delRole(List<com.dxy.console.po.Role> modules) throws Exception {
