...
public interface ModuleMapper {
    ...
    void insertModule(com.dxy.console.po.Module module);
    ...
    @Update("<script>" +
            ...
            " where id=#{id}" +
            "</script>")
    void updateModule(com.dxy.console.po.Module module);
    ...
    @Delete("<script>" +
            ...
            "</foreach></if>" +
            "</script>")
    void delModule(List<com.dxy.console.po.Module> modules);
}
