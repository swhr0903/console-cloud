...
public class RSAUtils {
  ...
  public static void saveKey(KeyPair keyPair, String keyFile)
  ...
  public static Key loadKey(String filename, int type)
      throws ConfigurationException, NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    if (type == 0) {
      ...
      X509EncodedKeySpec bobPubKeySpec = new X509EncodedKeySpec(toBytes(publicKeyValue));
